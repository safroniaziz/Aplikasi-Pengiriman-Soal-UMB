...
class MataKuliahController extends Controller
{
    ...
    public function post(Request $request){
        $validatedData = $request->validate([
            ...
            'kode_mata_kuliah' => 'required|string|unique:mata_kuliahs,kode_mata_kuliah',  // Validasi kode mata kuliah harus unik
    ...
    public function update(Request $request, MataKuliah $mataKuliah) {
        ...
        $validatedData = $request->validate([
            'prodi_id' => 'required|exists:program_studis,id',  // Validasi prodi_id harus ada di tabel program_studis
            'kode_mata_kuliah' => 'required|string|unique:mata_kuliahs,kode_mata_kuliah,' . $mataKuliah->id,  // Mengabaikan kode yang sama dengan mata kuliah yang sedang diupdate
            'nama_mata_kuliah' => 'required|string',  // Validasi nama mata kuliah
        ], [
            'prodi_id.required' => 'Program studi wajib dipilih.',
            'prodi_id.exists' => 'Program studi tidak ditemukan.',
