...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('data_dosen')->group(function () {
        Route::get('/', [MataKuliahController::class, 'index'])->name('dosen');
        Route::post('/', [MataKuliahController::class, 'post'])->name('dosen.post');
        Route::get('/{dosen}/edit', [MataKuliahController::class, 'edit'])->name('dosen.edit');
        Route::patch('/{dosen}', [MataKuliahController::class, 'update'])->name('dosen.update');
        Route::delete('/{dosen}', [MataKuliahController::class, 'delete'])->name('dosen.delete');
    });
});
