...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('ujian')->group(function () {
        Route::get('/', [UjianController::class, 'index'])->name('mataKuliah');
        Route::post('/', [UjianController::class, 'post'])->name('mataKuliah.post');
        Route::get('/{mataKuliah}/edit', [UjianController::class, 'edit'])->name('mataKuliah.edit');
        Route::patch('/{mataKuliah}', [UjianController::class, 'update'])->name('mataKuliah.update');
        Route::delete('/{mataKuliah}', [UjianController::class, 'delete'])->name('mataKuliah.delete');
    });
});
