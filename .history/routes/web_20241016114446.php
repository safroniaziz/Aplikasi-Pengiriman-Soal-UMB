...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('ujian')->group(function () {
        Route::get('/', [KopSoa::class, 'index'])->name('ujian');
        Route::post('/', [KopSoa::class, 'post'])->name('ujian.post');
        Route::get('/{ujian}/edit', [KopSoa::class, 'edit'])->name('ujian.edit');
        Route::patch('/{ujian}', [KopSoa::class, 'update'])->name('ujian.update');
        Route::delete('/{ujian}', [KopSoa::class, 'delete'])->name('ujian.delete');
    });
});
