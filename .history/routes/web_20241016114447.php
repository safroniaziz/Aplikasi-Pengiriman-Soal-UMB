...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('ujian')->group(function () {
        Route::get('/', [KopSoalUjianController::class, 'index'])->name('ujian');
        Route::post('/', [KopSoalUjianController::class, 'post'])->name('ujian.post');
        Route::get('/{ujian}/edit', [KopSoalUjianController::class, 'edit'])->name('ujian.edit');
        Route::patch('/{ujian}', [KopSoalUjianController::class, 'update'])->name('ujian.update');
        Route::delete('/{ujian}', [KopSoalUjianController::class, 'delete'])->name('ujian.delete');
    });
});
