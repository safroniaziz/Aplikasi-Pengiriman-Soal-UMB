...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('kop_soal_ujian')->group(function () {
        Route::get('/', [KopSoalUjianController::class, 'index'])->name('kop');
        Route::post('/', [KopSoalUjianController::class, 'post'])->name('kop.post');
        Route::get('/{kop}/edit', [KopSoalUjianController::class, 'edit'])->name('kop.edit');
        Route::patch('/{kop}', [KopSoalUjianController::class, 'update'])->name('kop.update');
        Route::delete('/{kop}', [KopSoalUjianController::class, 'delete'])->name('kop.delete');
    });
});
