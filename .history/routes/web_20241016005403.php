...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('program_studi')->group(function () {
        Route::get('/', [DosenController::class, 'index'])->name('prodi');
        Route::post('/', [DosenController::class, 'post'])->name('prodi.post');
        Route::get('/{programStudi}/edit', [DosenController::class, 'edit'])->name('prodi.edit');
        Route::patch('/{programStudi}', [DosenController::class, 'update'])->name('prodi.update');
        Route::delete('/{programStudi}', [DosenController::class, 'delete'])->name('prodi.delete');
    });
});
