...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('ujian')->group(function () {
        ...
        Route::post('/', [KopSoalkopController::class, 'post'])->name('kop.post');
        Route::get('/{kop}/edit', [KopSoalkopController::class, 'edit'])->name('kop.edit');
        Route::patch('/{kop}', [KopSoalkopController::class, 'update'])->name('kop.update');
        Route::delete('/{kop}', [KopSoalkopController::class, 'delete'])->name('kop.delete');
    });
});
