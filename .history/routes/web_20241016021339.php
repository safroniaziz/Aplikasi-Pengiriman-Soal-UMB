...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('ujian')->group(function () {
        Route::get('/', [Ujia::class, 'index'])->name('mataKuliah');
        Route::post('/', [Ujia::class, 'post'])->name('mataKuliah.post');
        Route::get('/{mataKuliah}/edit', [Ujia::class, 'edit'])->name('mataKuliah.edit');
        Route::patch('/{mataKuliah}', [Ujia::class, 'update'])->name('mataKuliah.update');
        Route::delete('/{mataKuliah}', [Ujia::class, 'delete'])->name('mataKuliah.delete');
    });
});
