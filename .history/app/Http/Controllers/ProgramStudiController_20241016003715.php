...
class ProgramStudiController extends Controller
{
    ...
    public function kategoriAnggotaPost(Request $request){
    ...
    public function kategoriAnggotaUpdate(Request $request, KategoriAnggota $kategoriAnggota) {
        // Validasi data
        $request->validate([
            'nama_kategori' => 'required|string',
        ], [
        ...
        try {
            $kategoriAnggota = KategoriAnggota::findOrFail($kategoriAnggota->id);
