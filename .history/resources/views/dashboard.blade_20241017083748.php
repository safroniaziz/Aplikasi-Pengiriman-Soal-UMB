                            ...
                            <div class="col-7 ps-xl-13">
                                ...
                                <div class="d-flex flex-column flex-sm-row d-grid gap-2">
                                    ...
                                    <form action="{{ route('dashboard') }}" method="POST" id="logout-form">
                                        @csrf
                                        <button type="submit" class="btn btn-primary flex-shrink-0" style="background: rgba(255, 255, 255, 0.2)">Sign Out</button>
                                    </form>
                                    <a href="{{ route('') }}" class="btn btn-primary flex-shrink-0" style="background: rgba(255, 255, 255, 0.2)" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Dokumen Rapat</a>
                                </div>
                                <!--end::Action-->
                            </div>
                            <!--end::Col-->
