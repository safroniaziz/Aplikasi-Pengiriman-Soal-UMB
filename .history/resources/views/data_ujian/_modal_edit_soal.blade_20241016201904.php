        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="mb-3">
                        <label for="edit_pengupload_id" class="form-label">Dosen Pengupload Soal</label>
                        <select class="form-control" id="edit_pengupload_id" name="pengupload_id" required>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="updateUjian()">Update</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    function updateUjian() {
        ...
        $.ajax({
            url: "{{ route('ujian.updateSoal', ':ujian') }}".replace(':ujian', id),
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            error: function(xhr) {
                var errorMessage = "Terjadi kesalahan saat mengupdate Ujian.";
                if (xhr.responseJSON) {
