                        ...
                        @foreach ($ujians as $index => $ujian)
                            <tr>
                                ...
                                <td>
                                    @if (Auth::user()->role == "dosen")
                                        @if($ujian->soalUjian)
                                            <a href="{{ Storage::url($ujian->soalUjian->path_file) }}" target="_blank"><i class="fa fa-check-circle"></i>&nbsp; Download {{ $ujian->soalUjian->nama_file }}</a>
                                        @elseif($now->lessThan($waktuMulai))
                                    ...
                                    @else
                                        ...
                                        @else
                                            ...
                                            @else
                                                <p class="text-warning"> Tidak Diupload</p>
                                            @endif
                                        @endif
                                    @endif
                                </td>
