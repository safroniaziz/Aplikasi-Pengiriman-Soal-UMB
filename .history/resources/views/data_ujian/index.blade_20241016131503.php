...
@push('scripts')
    ...
    $.ajax({
        url: '{{ route("ujian.updateKopSoal", ":ujian") }}'.replace(':ujian', ujian_id),  // Route dengan parameter ujian
        method: "POST",  // Method POST karena FormData tidak mendukung PATCH secara langsung
        data: formData,
        processData: false,
        contentType: false,
        headers: {
