                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <button type="button" class="btn btn-sm btn-primary" onclick="editUjian({{ $mataKuliah->id }})">Edit</button>
                                        <button type="button" class="btn btn-sm btn-danger" onclick="hapusUjian({{ $mataKuliah->id }})">Hapus</button>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
        ...
        function editUjian(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#mata_kuliah_id_id').val(response.id);
        ...
        function hapusUjian(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('mataKuliah.delete', ':mataKuliah') }}".replace(':mataKuliah', id),
                        method: 'DELETE',
                        data: {
