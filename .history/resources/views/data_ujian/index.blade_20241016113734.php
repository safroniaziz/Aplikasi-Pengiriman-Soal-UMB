                    ...
                    <tbody>
                        @foreach ($ujians as $index => $ujian)
                            <tr>
                                ...
                                <td>
                                    <!-- Logic for Status -->
                                    @if (\Carbon\Carbon::now()->greaterThan(\Carbon\Carbon::parse($ujian->tanggal_dilaksanakan)->setTimeFromTimeString($ujian->waktu_selesai)))
                                        <span class="label bg-success">Selesai</span>
                                    @else
                                        <span class="label bg-warning">Belum Selesai</span>
                                    @endif
                                </td>
                                <td>
        ...
        function editUjian(id) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#edit_waktu_mulai').val(response.waktu_mulai);  // Set Waktu Mulai
                    $('#edit_waktu_selesai').val(response.waktu_selesai);  // Set Waktu Selesai
