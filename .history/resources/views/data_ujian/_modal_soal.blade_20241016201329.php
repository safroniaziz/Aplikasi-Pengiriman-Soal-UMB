        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formUploadSoal" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="file_soal" class="form-label">Upload Soal</label>
                        <input type="file" class="form-control" id="file_soal" name="file_soal" accept=".pdf" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                <button type="button" class="btn btn-primary" onclick="submitFormUploadSoal()">Upload</button>
            </div>
        </div>
    </div>
</div>
