    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editKopSoalModalLabel">Edit Kop Soal Ujian</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="formEditKopSoal" enctype="multipart/form-data">
                    @csrf
                    <input type="text" id="edit_ujian_kop_id" name="ujian_id">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="edit_file_kop_soal" class="form-label">Upload Kop Soal Baru</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" onclick="submitEditForm()">Simpan Perubahan</button>
            </div>
        </div>
    </div>
</div>
