...
@push('scripts')
    <script>
                ...
                success: function(response) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            // Pilih dosen yang sudah ada (pengupload_id)
        ...
        function submitEditForm() {
            var ujian_id = $('#edit_ujian_id').val();
            var formData = new FormData(document.getElementById('formEditKopSoal'));

            $.ajax({
                url: '{{ route("ujian.updateKopSoal", ":ujian") }}'.replace(':ujian', ujian_id),
                method: "POST",  // Method POST dengan override ke PATCH
                data: formData,
                processData: false,
                contentType: false,
                headers: {
                    'X-HTTP-Method-Override': 'PATCH'  // Override method ke PATCH
                },
                success: function(response) {
                    Swal.fire({
                        title: "Berhasil!",
                ...
                error: function(xhr) {
                    ...
                    if (xhr.status === 422) {
                        ...
                        Swal.fire({
                            title: "Error!",
                            text: "Terjadi kesalahan saat mengupdate kop soal.",
                            icon: "error",
                            confirmButtonText: "OK"
                        });
                    }
