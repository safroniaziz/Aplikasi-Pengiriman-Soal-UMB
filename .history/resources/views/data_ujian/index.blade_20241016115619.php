                            ...
                            <tr>
                                ...
                                <td>
                                    @if($ujian->kopSoalUjian)
                                        <span class="badge bg-info">Kop Soal Terupload</span>
                                        <a href="{{ Storage::url($ujian->kopSoalUjian->path_file) }}" target="_blank" class="btn btn-sm btn-success">Download {{ $ujian->kopSoalUjian->nama_file }}</a>
                                    ...
                                    @elseif($now->lessThan($waktuMulai))
                                        ...
                                        <button class="btn btn-sm btn-primary" onclick="uploadKopSoal({{ $ujian->id }})">Upload Kop Soal</button>
                                    @else
...
@push('scripts')
    <script>
        ...
        function submitFormUpload() {
            ...
            $.ajax({
                url: "{{ route('kopsoal.upload') }}",  // Route untuk upload kop soal ujian
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
