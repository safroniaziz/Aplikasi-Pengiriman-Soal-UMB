                            ...
                            <tr>
                                ...
                                <td>
                                    @if($ujian->kopSoalUjian)
                                        ...
                                        <a href="{{ Storage::url($ujian->kopSoalUjian->path_file) }}" target="_blank">Download {{ $ujian->kopSoalUjian->nama_file }}</a>
                                        <button class="btn btn-sm btn-primary" onclick="updateKopSoal({{ $ujian->id }})">Update</button>
