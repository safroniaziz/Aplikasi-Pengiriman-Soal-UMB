                        ...
                        <div class="row gx-9 h-100">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="d-flex flex-stack mb-6">
                                            ...
                                            <div class="flex-shrink-0 me-5">
                                                <span class="text-gray-500 fs-7 fw-bold me-2 d-block lh-1 pb-1">Dokumen Risalah Rapat</span>
                                                <span class="text-gray-800 fs-1 fw-bold">Kabupaten Kepahiang</span>
                                            </div>
                                        </div>
                                        <!--end::Heading-->
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        <!--begin::Text-->
                                        <span class="fw-semibold text-gray-600 fs-6 mb-8 d-block">Kemudahan Dalam Membuat Risalah Rapat, Hanya Dengan Berbicara Menggunakan Microphone</span>
                                        <!--end::Text-->
                                        <!--begin::Stats-->
                                    ...
                                    <div class="d-flex flex-stack mt-auto bd-highlight">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 me-6 mb-3">
                                                <!--begin::Date-->
                                                <span class="fs-6 text-gray-700 fw-bold">Jumlah Anggota</span>
                                                <!--end::Date-->
                                                <!--begin::Label-->
                                                <div class="fw-semibold text-gray-500">{{ $jumlahAnggota }}</div>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Stat-->
                                            <!--begin::Stat-->
                                            <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 mb-3">
                                                <!--begin::Number-->
                                                <span class="fs-6 text-gray-700 fw-bold">Jumlah Risalah</span>
                                                <!--end::Date-->
                                                <!--begin::Label-->
                                                <div class="fw-semibold text-gray-500">{{ $jumlahRisalah }}</div>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Stat-->
                                        </div>
                        ...
                        <div class="row align-items-center h-100">
                            ...
                            <div class="col-7 ps-xl-13">
                                ...
                                <div class="d-flex flex-column flex-sm-row d-grid gap-2">
                                    <a href="{{ route('risalah.registrasiRapat') }}" class="btn btn-success flex-shrink-0 me-lg-2" >Registrasi Rapat</a>
                                    <a href="{{ route('user.home') }}" class="btn btn-primary flex-shrink-0" style="background: rgba(255, 255, 255, 0.2)" data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Dokumen Rapat</a>
                                </div>
                                <!--end::Action-->
                            </div>
                            <!--end::Col-->
