        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formProdi">
                    @csrf
                    <div class="mb-3">
                        <label for="kode_prodi" class="form-label">Kode D</label>
                        <input type="text" class="form-control" id="nama_prodi" name="kode_prodi" placeholder="Masukkan kode prodi" required>
                    </div>
