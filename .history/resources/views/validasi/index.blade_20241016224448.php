                                    ...
                                    <div class="d-flex gap-2">
                                        @if($ujian->soalUjian)
                                            @if ($ujian->soalUjian->validasi && $ujian->soalUjian->validasi->status == "validated")
                                                <p class="text-success"><i class="fa fa-check-circle"></i>&nbsp; Validated</p>
                                            @elseif($ujian->soalUjian->validasi && $ujian->soalUjian->validasi->status == "validated")
                                                <p class="text-danger"><i class="fa fa-close"></i>&nbsp; Rejected</p>
                                            @endif
