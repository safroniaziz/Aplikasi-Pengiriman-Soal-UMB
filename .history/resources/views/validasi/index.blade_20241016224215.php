...
@section('content')
    ...
    <!-- Tampilkan sesuatu jika validasi ada -->
@else
    <!-- Tampilkan sesuatu jika validasi tidak ada -->
@endif

                                    @if ($ujian->soalUjian->validasi)
                                                <p class="text-green">
                                                    <i class="fa fa-check-circle">Validated</i>
                                                </p>
                                            @else
                                            <p class="text-danger">
                                                <i class="fa fa-check-circle">Rejected</i>
                                            </p>
                                            @endif
                                    </div>
                                </td>
