        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formDosen">
                    ...
                    <div class="mb-3">
                        <label for="nama_mata_kuliah" class="form-label">nama_mata_kuliah</label>
                        <input type="text" class="form-control" id="nama_mata_kuliah" name="nama_mata_kuliah" placeholder="Masukkan nama_mata_kuliah" required>
                    </div>
