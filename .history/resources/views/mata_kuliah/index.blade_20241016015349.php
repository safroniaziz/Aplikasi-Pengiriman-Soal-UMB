                ...
                <table id="kt_datatable_fixed_header" class="table table-striped table-row-bordered gy-5 gs-7">
                    ...
                    <tbody>
                        @foreach ($dosens as $index => $dosen)
                            <tr>
                                <td>{{ $index+1 }}</td>
                                <td>{{ $dosen->kode_mata_kuliah }}</td>
                                <td>{{ $dosen->nama_mata_kuliah }}</td>
                                <td>{{ $dosen->prodi->nama_prodi }}</td>
                                <td>
                                    <div class="d-flex justify-content-between gap-2">
                                        <button type="button" class="btn btn-sm btn-primary" onclick="editMataKuliah({{ $dosen->id }})">Edit</button>
                                        <button type="button" class="btn btn-sm btn-danger" onclick="hapusMataKuliah({{ $dosen->id }})">Hapus</button>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
