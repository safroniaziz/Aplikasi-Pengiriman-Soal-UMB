...
@push('scripts')
    <script>
        ...
        function editProdi(id) {
            $.ajax({
                url: '{{ route("prodi.edit", ":id") }}'.replace(':id', id),  // Menggunakan route name 'prodi.edit'
                type: 'PATCH',
                success: function(response) {
                    // Mengisi data ke dalam form edit
                    $('#prodi_id').val(response.id);
                    $('#edit_kode_prodi').val(response.kode_prodi);
                    $('#edit_nama_prodi').val(response.nama_prodi);
