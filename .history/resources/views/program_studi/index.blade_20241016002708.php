                    ...
                    <tbody>
                        @foreach ($prodis as $index => $prodi)
                            <tr>
                                ...
                                <td>{{ $prodi->misi }}</td>
                                <td>
                                    <button type="button" class="btn btn-sm btn-primary" onclick="editProdi({{ $prodi->id }}, '{{ $prodi->nama_kategori }}')">Edit</button>
                                    <button type="button" class="btn btn-sm btn-danger" onclick="hapusKategori({{ $prodi->id }})">Hapus</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
...
@push('scripts')
    <script>
        ...
        function editProdi(id, namaKategori) {
            $('#kategori_id').val(id);
