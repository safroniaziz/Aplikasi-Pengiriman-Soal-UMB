        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formProdi">
                    ...
                    <div class="mb-3">
                        <label for="jenjang_prodi" class="form-label">Jenjang</label>
                        <input type="text" class="form-control" id="jenjang_prodi" name="jenjang_prodi" placeholder="Masukkan jenjang prodi" required>
                    </div>

                    <div class="mb-3">
                        <label for="visi_prodi" class="form-label">Visi Program Studi</label>
                        <textarea class="form-control" id="visi_prodi" name="visi_prodi" rows="5" placeholder="Masukkan visi prodi" required></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="misi_prodi" class="form-label">Misi Program Studi</label>
                        <textarea class="form-control" id="misi_prodi" name="misi_prodi" rows="5" placeholder="Masukkan misi prodi" required></textarea>
                    </div>
                </form>
            </div>
