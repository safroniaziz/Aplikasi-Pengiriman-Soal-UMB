        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <div class="mb-3">
                        <label for="kode_prodi" class="form-label">Nama Program Studi</label>
                        <input type="text" class="form-control" id="edit_kode_prodi" name="kode_prodi" placeholder="Masukkan nama prodi" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="edit_jenjang" name="jenjang" placeholder="Masukkan jenjang prodi" required>
                    </div>
