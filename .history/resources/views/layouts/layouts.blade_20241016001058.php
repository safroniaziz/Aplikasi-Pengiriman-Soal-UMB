					...
					<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
                                <h1 class="text-white my-1 fs-1 d-flex fw-bold">SELAMAT DATANG DI APLIKASI PENGIRIMAN DAN PENERIMAAN SOAL UJIAN <br> FAKULTAS TEKNIK UNIVERSITAS MUHAMMADIYAH BENGKULU</h1>
			...
			<div class="card card-flush w-100 rounded-0">
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<!--end::Wrapper-->Se/assets/media/stock/600x400/img-1.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
