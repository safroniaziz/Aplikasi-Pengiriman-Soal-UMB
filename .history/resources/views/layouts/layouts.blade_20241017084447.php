					...
					<div id="kt_header" class="header align-items-stretch mb-5 mb-lg-10" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-center">
							...
							<div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
                                <a href="index.html">
                                    <img alt="Logo" src="{{ asset('assets/logo.png') }}" class="logo-default h-45px bg-white p-1 rounded" style="background-color: white; border-radius: 8px;" />
                                    <img alt="Logo" src="{{ asset('assets/logo.png') }}" class="logo-sticky h-25px bg-white p-1 rounded" style="background-color: white; border-radius: 8px;" />
                                </a>
                            </div>
                                    ...
                                    <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                                        ...
                                        <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0" id="kt_header_menu" data-kt-menu="true">
                                            ...
                                            @if (Auth::user()->role == "admin")
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->routeIs('prodi')  ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                                    <!--begin:Menu link-->
                                                    <a href="{{ route('prodi') }}" class="menu-link py-3">
                                                ...
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->routeIs('dosen') ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion me-0 me-lg-2">
                                                    <!--begin:Menu link-->
                                                    <a href="{{ route('dosen') }}" class="menu-link py-3">
                                                ...
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->routeIs('mataKuliah') ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion me-0 me-lg-2">
                                                    <!--begin:Menu link-->
                                                    <a href="{{ route('mataKuliah') }}" class="menu-link py-3">
                                            ...
                                            @if (Auth::user()->role == "admin" || Auth::user()->role == "dosen")
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->routeIs('ujian') ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion me-0 me-lg-2">
                                                    <!--begin:Menu link-->
                                                    <a href="{{ route('ujian') }}" class="menu-link py-3">
                                            ...
                                            @if (Auth::user()->role == "kaprodi")
                                                ...
                                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->routeIs('ujian') ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion me-0 me-lg-2">
                                                    <!--begin:Menu link-->
                                                    <a href="{{ route('validasi') }}" class="menu-link py-3">
                                                        <span class="menu-title">Validasi Soal Ujian</span>
                                                        <span class="menu-arrow d-lg-none"></span>
                                                    </a>
                                                    <!--end:Menu link-->
                                                </div>
								...
								<div class="topbar d-flex align-items-stretch flex-shrink-0">
                                    ...
                                    @if (auth()->check()) <!-- Cek apakah pengguna sudah login -->
                                        ...
                                        <div class="btn btn-icon btn-active-light-primary btn-custom w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                            <img class="h-30px w-30px rounded" src="{{ asset('assets/user.png') }}" alt="" />
                                        </div>
                                            ...
                                            <div class="menu-item px-3">
                                                <div class="menu-content d-flex align-items-center px-3">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <img alt="Logo" src="{{ asset('assets/user.png') }}" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Username-->
					...
					<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="page-title d-flex flex-column me-3">
								<!--begin::Title-->
                                <h1 class="text-white my-1 fs-1 d-flex fw-bold" style="text-transform: uppercase">HALLO, {{ Auth::user()->nama_lengkap }} <br>JANGAN LUPA LOGOUT SETELAH MENGGUNAKAN APLIKASI</h1>
