...
<html lang="en">
	...
	<head>
		...
		<link rel="shortcut icon" href="{{ asset('assets/risalah/assets/logo-risalah.png') }}" />
					...
					<div id="kt_header" class="header align-items-stretch mb-5 mb-lg-10" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
						...
						<div class="container-xxl d-flex align-items-center">
							...
							<div class="header-logo me-5 me-md-10 flex-grow-1 flex-lg-grow-0">
                                <a href="index.html">
                                    <img alt="Logo" src="{{ asset('assets/risalah/assets/logo-risalah.png') }}" class="logo-default h-45px bg-white p-1 rounded" style="background-color: white; border-radius: 8px;" />
                                    <img alt="Logo" src="{{ asset('assets/risalah/assets/media/logos/demo2-sticky.png') }}" class="logo-sticky h-25px bg-white p-1 rounded" style="background-color: white; border-radius: 8px;" />
                                </a>
                            </div>
                                ...
                                <div class="d-flex align-items-stretch" id="kt_header_nav">
                                    ...
                                    <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
                                        ...
                                        <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-500 fw-semibold my-5 my-lg-0 align-items-stretch px-2 px-lg-0" id="kt_header_menu" data-kt-menu="true">
                                            <!--begin:Menu item-->
                                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->d('risalah') ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion me-0 me-lg-2">
                                                <!--begin:Menu link-->
                                                <a href="{{ route('risalah') }}" class="menu-link py-3">
                                            ...
                                            <!--begin:Menu item-->
                                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->d('dokumenRapat')  ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                                <!--begin:Menu link-->
                                                <a href="{{ route('dokumenRapat') }}" class="menu-link py-3">
                                            ...
                                            <!--begin:Menu item-->
                                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->d('risalah.kategoriAnggota') ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion me-0 me-lg-2">
                                                <!--begin:Menu link-->
                                                <a href="{{ route('risalah.kategoriAnggota') }}" class="menu-link py-3">
                                            ...
                                            <!--begin:Menu item-->
                                            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item {{ request()->d('risalah.registrasiRapat') || request()->d('risalah.registrasiRapat.create') || request()->d('risalah.registrasiRapat.edit') || request()->d('risalah.registrasiRapat.detail') ? 'here show menu-here-bg' : '' }} menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                                <!--begin:Menu link-->
                                                <a href="{{ route('risalah.registrasiRapat') }}" class="menu-link py-3">
					...
					<div class="toolbar py-5 pb-lg-15" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
							...
							<div class="d-flex align-items-center py-3 py-md-1">
								...
								<div class="me-4">
									<!--begin::Menu-->
									<a href="{{ route('user.home') }}"  class="btn bg-body btn-active-color-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
