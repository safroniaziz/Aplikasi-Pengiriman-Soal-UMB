            ...
            <div class="container z-10">
                <div class="flex   ">
                    <div class=" flex flex-col w-full mx-auto md:flex-0 shrink-0 md:w-1/3
                        ...
                        <div
                            ...
                            <div class=" pb-0 mb- bg-transparent border-b-0 rounded-t-2xl w-full text-center ">
                                <h3
                                    class="mb-4 md:text-xl text-xl  z-10  text-transparent bg-gradient-to-tl from-black to-blue-500 font-bold  bg-clip-text">
                                    SILAHKAN LOGIN DI SINI <br>
                                    SISTEM INFORMASI PENGIRIMAN DAN PENERIMAAN SOAL UJIAN </h3>
                                <img src="{{ asset('assets/logo.png') }}" class="h-40 mx-auto mb-1" alt="logo">
                            </div>
                            ...
                            <div class=" pb-0 mb- bg-transparent border-b-0 rounded-t-2xl w-full text-center ">
                                <h4
                                    ...
                                    ADAPTIF E-LEARNING SYSTEM <br>SUPPORT BY RUMAHILMU.ORG</h4>
                            </div>
                        </div>
                    </div>
                    <div class="w-full   lg:flex-0 shrink-0 md:w-2/3  ">
                        ...
                        <lottie-player src="{{ asset('assets/animation.json') }}" background="transparent" speed="1" class="w-11/12 h-11/12 ml-20"
